...
// ============================================================================
// Luxury Chat Server - V13 UNITY UTF16 / SURROGATE HISTORY SAFE
...
//
// BUILD:
// 2026-08-10-LUXURY-CHAT-SERVER-V13-UNITY-UTF16-SURROGATE-HISTORY-SAFE
//
// server.js:
    ...
    async (
      ...
      try {
        ...
        return res.json({
          ...
          source:
            "cloudinary-sharded-v13-unity-utf16-safe-window",

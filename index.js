...
//
// Form Data:
// sessionTicket = PlayFab SessionTicket
// avatar = image file
// =====================================================
...
app.post(
    ...
    async (req, res) => {
        try {
            ...
            // التحقق من SessionTicket
            // وأخذ PlayFabId الحقيقي.
            const authResult =
